...
baseurl = 'https://cn.investing.com/economic-calendar/'
...
if __name__ == '__main__':
    url = 'https://cn.investing.com/economic-calendar/' # 公告
...
#    
    ...
    ###################### 全部导出至excel文件 ######################
    x.to_excel('D:\\python\\work\\web\\calendar_issues.xlsx',index=False,header=True)
